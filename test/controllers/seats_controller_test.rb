...
class SeatsControllerTest < ActionController::TestCase
  ...
  test "should create seat" do
    assert_difference('Seat.count') do
      post :create, seat: { row: @seat.row, screen_id: @seat.screen_id, seat_number: @seat.seat_number }
    end
  ...
  test "should update seat" do
    patch :update, id: @seat, seat: { row: @seat.row, screen_id: @seat.screen_id, seat_number: @seat.seat_number }
    assert_redirected_to seat_path(assigns(:seat))
  end
